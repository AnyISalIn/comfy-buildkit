...
class ComfyBuildkit:
    ...
    def _copy(self, *args: str) -> None:
        ...
        if len(sources) == 1 and not dest.endswith('/'):
            ...
            full_source_path: str = os.path.join(self.project_root, source)
    ...
    def _file_contents(self, content: Union[str, Dict[str, Any]], remote_path: str, json_dump: bool = False) -> None:
        temp_path: str = os.path.join(self.temp_dir, os.path.basename(remote_path))
    ...
    def copy_local_file(self, local_path: str, remote_path: str) -> 'ComfyBuildkit':
        ...
        temp_path: str = os.path.join(self.temp_dir, os.path.basename(local_path))
        os.makedirs(os.path.dirname(temp_path), exist_ok=True)
